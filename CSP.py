...
class Variable:
    ...
    def from_names_to_equal_domain(cls, names: set, domain: list, value=None) -> dict:
        ...
        for name in names:
            ...
            # else:
            name_to_variable_map[name] = cls(domain,None,name)
...
class ConstraintProblem:
    ...
    def __init__(self, constraints, name_to_variable_map = None):
...
def classic_heuristic_backtracking_search(constraint_problem: ConstraintProblem,
                                          primary_select_unassigned_vars=minimum_remaining_values,
                                          secondary_select_unassigned_vars=degree_heuristic,
                                          sort_domain=least_constraining_value,
                                          inference = None, with_history: bool = False):
...
def __classic_heuristic_backtrack(constraint_problem: ConstraintProblem,
                                  ...
                                  secondary_select_unassigned_vars = degree_heuristic,
                                  sort_domain = least_constraining_value,
                                  inference = None, with_history: bool = False) -> bool:
